<template>
  <div class="login-wrapper">
    ...
    <!-- ផ្នែកខាងស្តាំ៖ ផ្ទៃ Reset Password ទំនើប -->
    <div class="form-section">
      <div class="login-card">
        ...
        <div class="brand-header text-center mb-4">
          ...
          <p class="brand-subtitle">កំណត់ពាក្យសម្ងាត់ឡើងវិញ (Reset Password)</p>
        </div>

        <form @submit.prevent="sendResetPasswordEmail">
          <p class="instruction-text text-center mb-3">
            សូមបញ្ចូលអ៊ីមែលរបស់អ្នក ដើម្បីទទួលតំណភ្ជាប់សម្រាប់កំណត់ពាក្យសម្ងាត់ឡើងវិញ។
          </p>
          ...
          <button type="submit" class="btn btn-primary-theme btn-block w-100 mb-3">
            <span>ផ្ញើតំណភ្ជាប់ / Send Link</span> <i class="fas fa-paper-plane ml-2"></i>
          </button>
        </form>
        ...
        <div class="text-center auth-links">
          <router-link :to="{ name: 'auth.signin' }" class="d-block mb-2 link-item">
